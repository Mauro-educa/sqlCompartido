...
public class ParaHacer {
    ...
    /**
     * Clase que conecte a la BBDD:
     * Crear la clase y conectar a la base de datos
     * calcularPrecio(): recibe un pedido, calcula su precio total a partir de los platos que tiene y hace un set en la clase Pedido.
     */
